...
fixtures = [
    # 1. Custom Fields and Layout Changes (Property Setters)
    {"dt": "Custom Field", "filters": [["dt", "in", ["Employee", "Employee Separation", "Resignation Request"]]]},
    {"dt": "Property Setter", "filters": [["doc_type", "in", ["Employee", "Employee Separation", "Resignation Request"]]]},

    # 2. Roles and Permissions (Crucial for HR vs Employee access)
    # {"dt": "Role"},
    # {"dt": "Custom Role Inventory"},
    # {"dt": "Custom DocPerm"},
	{"dt": "Role"},
    
    # Export standard permissions linked to DocTypes
    {"dt": "DocPerm"},
    
    # Export overrides made via the Role Permission Manager
    {"dt": "Custom DocPerm"},
    
    # Optional: If you created specific Permission Queries
    
	{"dt": "Client Script"},
    
    # Export all Server Scripts (Python)
    {"dt": "Server Script"},
    
    # If you used any API keys or specific System Settings
    {"dt": "System Settings", "filters": [["name", "=", "System Settings"]]},

    # 3. Workflows (The logic for Resignation -> Separation)
    {"dt": "Workflow"},
    {"dt": "Workflow State"},
    {"dt": "Workflow Action"},

    # 4. Workspace and Dashboards (The UI your teammate sees)
    {"dt": "Workspace"},
    {"dt": "Dashboard"},
    {"dt": "Dashboard Chart"},
    {"dt": "Number Card"},

    # 5. Templates (Like the Separation Checklist template)
